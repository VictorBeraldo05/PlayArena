...
function EmailConfirmationNotice() { return <aside className="success-reveal success-reveal-email mt-4 flex w-full items-start gap-3 rounded-[18px] border border-white/[.08] bg-[#111923]/72 p-3.5 text-left backdrop-blur-md"><span aria-hidden="true" className="grid h-9 w-9 shrink-0 place-items-center rounded-xl border border-[#8FFF3C]/20 bg-[#8FFF3C]/[.08] text-[#8FFF3C]"><MailIcon /></span><div className="min-w-0"><p className="text-sm font-extrabold leading-5 text-white">Fique de olho no seu e-mail</p><p className="mt-1 text-xs leading-[1.45] text-[#9DA7B3]">Assim que a arena confirmar sua reserva, enviaremos a confirmação para o e-mail da sua conta.</p></div></aside>; }
...
function MailIcon() { return <svg aria-hidden="true" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.9" viewBox="0 0 24 24"><rect height="14" rx="2.5" width="18" x="3" y="5" /><path d="m4 7 8 6 8-6" /></svg>; }
